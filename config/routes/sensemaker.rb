namespace :sensemaker do
  ...
  get ":resource_type/:resource_id/jobs", to: "jobs#index",
      constraints: { resource_type: /debates|proposals|polls|topics|poll_questions|legislation-questions|legislation_questions|legislation_proposals|legislation_question_options/ },
      as: :resource_jobs
